...
<center> 
  ...
  <?php
    ...
    for ($x = 0; $x < $cartas; $x++){
      echo "<input type='hidden' name='pc".($x+1)."' value='".$pcsorteio[$x]."'>";
    }
  ?>
    ...
    if ($acao == 'jogar'){
      ...
      echo "<h2> Jogador: <h2>";
        ...
        $resultadoj = $h1 + $h2 + $h3 + $h4 + $h5 + $h6;
          ...
          $pc1 = isset($_POST['pc1']) ? $_POST['pc1'] : 0;
          if ($pc1 == 1 && $naipe == 2)
        echo "<img src='img/asouro.png' width='100'>";
        ...
        $pc2 = isset($_POST['pc2']) ? $_POST['pc2'] : 0;
          if ($pc2 == 1 && $naipe == 2)
        echo "<img src='img/asouro.png' width='100'>";
        ...
        $pc3 = isset($_POST['pc3']) ? $_POST['pc3'] : 0;
          if ($pc3 == 1 && $naipe == 2)
        echo "<img src='img/asouro.png' width='100'>";
        ...
        $pc4 = isset($_POST['pc4']) ? $_POST['pc4'] : 0;
          if ($pc4 == 1 && $naipe == 2)
        echo "<img src='img/asouro.png' width='100'>";
        ...
        $pc5 = isset($_POST['pc5']) ? $_POST['pc5'] : 0;
          if ($pc5 == 1 && $naipe == 2)
        echo "<img src='img/asouro.png' width='100'>";
        ...
        $pc6 = isset($_POST['pc6']) ? $_POST['pc6'] : 0;
          if ($pc6 == 1 && $naipe == 2)
        echo "<img src='img/asouro.png' width='100'>";
